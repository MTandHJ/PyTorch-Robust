...
parser.add_argument("--omega", type=int, default=0.0,
                help="random sample parameter for adv data generation")
parser.add_argument("--random-type", type=str, default='normal')
...
parser.add_argument("-lp", "--learning_policy", type=str, default="FAT-TRADES", 
...
def load_cfg() -> Tuple[Config, str]:
    ...
    from src.attacks import LinfFrendlyPGDKL
