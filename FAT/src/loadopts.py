...
def load_attack(
    ...
    if attack_type == 'pgd-linf':
        ...
        attack = L2PGDKLdiv
    elif attack_type == "fpgd-linf":
        from .attacks import FriendlyPGD
        attack = FriendlyPGD
    elif attack_type == "fpgd-linf-kl":
        from .attacks import FriendlyPGDKL
        attack = FriendlyPGDKL
    else:
        raise AttackNotIncludeError(f"Attack {attack_type} is not included.\n" \
