...
class ResNet(ADArch):
    def __init__(self, block, layers, scale=10, num_classes=1000, zero_init_residual=False,
        ...
        self._generateOptMeans(
            self.fc,
            dim_feature=512 * block.expansion,
    ...
    def forward(self, x):
        ...
        features = torch.flatten(x, 1).unsqueeze(dim=1) # N x 1 x 512
