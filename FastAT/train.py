...
SAVE_FREQ = 5
PRINT_FREQ = 20
FMT = "{description}={learning_policy}-{optimizer}-{lr_min}-{lr_max}" \
...
parser.add_argument("--attack", type=str, default="pgd-linf",
                help="fgsm with random start ...")
parser.add_argument("--epsilon", type=float, default=8/255)
parser.add_argument("--stepsize", type=float, default=1.25, 
                help="FastAT use an abs stepsize 10 / 255 not 8 / 255")
...
parser.add_argument("-m", "--description", type=str, default="FastAT")
