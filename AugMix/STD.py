...
parser.add_argument("-lp", "--learning_policy", type=str, default="AugMix", 
                help="learning rate schedule defined in config.py")
parser.add_argument("--epochs", type=int, default=200)
parser.add_argument("-b", "--batch_size", type=int, default=128)
parser.add_argument("--transform", type=str, default='augmix,none', 
...
def load_cfg() -> Tuple[Config, str]:
    ...
    learning_policy = load_learning_policy(
        ...
        lr_lambda=lambda step: get_lr(step, opts.epochs * len(cfg.trainloader), 1, 1e-6 / opts.lr),
        T_max=opts.epochs
    )
